...
local Colors = {
	PageTextPressed = Color3fromRGB(0, 0, 0);
	PageBackgroundPressed = Color3fromRGB(0, 0, 0);
	PageBorderPressed = Color3fromRGB(0, 0, 0);
	PageTextHover = Color3fromRGB(0, 0, 0);
	PageBackgroundHover = Color3fromRGB(0, 0, 0);
	PageTextIdle = Color3fromRGB(0, 0, 0);
	PageBackgroundIdle = Color3fromRGB(0, 0, 0);
	PageBorderIdle = Color3fromRGB(0, 0, 0);
	ElementBackground = Color3fromRGB(0, 0, 0);
}
